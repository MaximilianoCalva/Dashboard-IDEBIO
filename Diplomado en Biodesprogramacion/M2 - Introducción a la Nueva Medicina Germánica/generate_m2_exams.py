...
exams = [
    {
        "title": "EXAMEN: LA NUEVA MEDICINA GERMÁNICA 1",
        "url": "https://fernandosanchezinstituto.com.mx/la-nueva-medicina-germanica-1/"
    }
]
...
output_file = os.path.join(output_dir, "snippet-examenes-nmg1.html")
