...
exams = [
    {
        "title": "EXAMEN: PNL E HIPNOSIS",
        "url": "https://fernandosanchezinstituto.com.mx/examen-pnl-e-hipnosis/"
    }
]
...
output_file = os.path.join(output_dir, "snippet-examenes-pnl-hipnosis.html")
