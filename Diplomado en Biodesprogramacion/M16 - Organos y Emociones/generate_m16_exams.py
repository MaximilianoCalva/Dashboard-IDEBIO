...
exams = [
    {
        "title": "EXAMEN: ÓRGANOS Y EMOCIONES: CONFLICTO POR CAPAS EMBRIONARIAS",
        "url": "https://fernandosanchezinstituto.com.mx/examen-organos-y-emociones/"
    }
]
...
output_file = os.path.join(output_dir, "snippet-examenes-organos-emociones.html")
