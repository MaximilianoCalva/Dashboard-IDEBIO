...
exams = [
    {
        "title": "EXAMEN: ÓRGANOS Y EMOCIONES II: CONFLICTO POR CAPAS EMBRIONARIAS",
        "url": "https://fernandosanchezinstituto.com.mx/examen-organos-y-emociones-iii/"
    }
]
        ...
        <div class="flex items-start justify-between mb-4">
            <div>
                ...
                <h2 class="text-lg md:text-2xl font-bold text-gray-800 leading-tight">
                    ...
                    <span class="text-[#233878]">1 examen</span>
                </h2>
...
output_file = os.path.join(output_dir, "snippet-examenes-organos-emociones-iii.html")
