...
exams = [
    {
        "title": "EXAMEN: LA NUEVA MEDICINA GERMÁNICA 2",
        "url": "https://fernandosanchezinstituto.com.mx/la-nueva-medicina-germanica-2/"
    }
]
...
output_file = os.path.join(output_dir, "snippet-examenes-nmg2.html")
