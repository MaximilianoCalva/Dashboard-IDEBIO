...
exams = [
    {
        "title": "EXAMEN: INTRODUCCIÓN A LA BIODESPROGRAMACIÓN",
        "url": "https://fernandosanchezinstituto.com.mx/examen-introduccion-a-la-biodesprogramacion/"
    }
]
...
output_file = os.path.join(output_dir, "snippet-examenes-introduccion.html")
