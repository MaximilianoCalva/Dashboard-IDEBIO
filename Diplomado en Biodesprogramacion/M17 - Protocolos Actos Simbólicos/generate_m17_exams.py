...
exams = [
    {
        "title": "EXAMEN: PROTOCOLOS: ACTOS SIMBÓLICOS",
        "url": "https://fernandosanchezinstituto.com.mx/examen-protocolos-actos-simbolicos/"
    }
]
...
output_file = os.path.join(output_dir, "snippet-examenes-protocolos.html")
