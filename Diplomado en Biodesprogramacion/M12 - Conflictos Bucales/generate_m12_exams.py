...
exams = [
    {
        "title": "EXAMEN: CONFLICTOS BUCALES EN BIODESPROGRAMACIÓN",
        "url": "https://fernandosanchezinstituto.com.mx/examen-conflictos-bucales-en-biodesprogramacion/"
    }
]
...
output_file = os.path.join(output_dir, "snippet-examenes-conflictos-bucales.html")
