...
exams = [
    {
        "title": "EXAMEN: TIPOS DE CUERPO Y ALIMENTOS EN BIODESPROGRAMACIÓN",
        "url": "https://fernandosanchezinstituto.com.mx/examen-tipos-de-cuerpo-y-alimentos-en-biodesprogramacion/"
    },
    {
        "title": "EXAMEN: TIPOS DE CUERPO Y ALIMENTOS EN BIODESPROGRAMACIÓN CASO 1",
        "url": "https://fernandosanchezinstituto.com.mx/examen-tipos-de-cuerpo-y-alimentos-en-biodesprogramacion-caso-1/"
    },
    {
        "title": "EXAMEN: TIPOS DE CUERPO Y ALIMENTOS EN BIODESPROGRAMACIÓN CASO 2",
        "url": "https://fernandosanchezinstituto.com.mx/examen-tipos-de-cuerpo-y-alimentos-en-biodesprogramacion-caso-2/"
    },
    {
        "title": "EXAMEN: TIPOS DE CUERPO Y ALIMENTOS EN BIODESPROGRAMACIÓN CASO 3",
        "url": "https://fernandosanchezinstituto.com.mx/examen-tipos-de-cuerpo-y-alimentos-en-biodesprogramacion-caso-3/"
    },
    {
        "title": "EXAMEN: TIPOS DE CUERPO Y ALIMENTOS EN BIODESPROGRAMACIÓN CASO 4",
        "url": "https://fernandosanchezinstituto.com.mx/examen-tipos-de-cuerpo-y-alimentos-en-biodesprogramacion-caso-4/"
    }
]

# HTML Template
html_content = """<!-- Tailwind CSS -->
        ...
        <div class="flex items-start justify-between mb-4">
            <div>
                ...
                <h2 class="text-lg md:text-2xl font-bold text-gray-800 leading-tight">
                    Esta materia contiene: <br>
                    <span class="text-[#233878]">5 examenes</span>
                </h2>
...
output_file = os.path.join(output_dir, "snippet-examenes-alimentacion.html")

full_html = html_content + generate_list_items(exams) + footer_content
