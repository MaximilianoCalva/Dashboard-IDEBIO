...
exams = [
    {
        "title": "EXAMEN: COACHING APLICADO A LA BIODESPROGRAMACIÓN",
        "url": "https://fernandosanchezinstituto.com.mx/examen-coaching-aplicado-a-la-biodesprogramacion/"
    }
]
...
output_file = os.path.join(output_dir, "snippet-examenes-coaching.html")
