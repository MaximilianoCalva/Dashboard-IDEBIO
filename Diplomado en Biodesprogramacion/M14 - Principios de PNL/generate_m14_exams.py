...
exams = [
    {
        "title": "EXAMEN: PRINCIPIOS DE PNL",
        "url": "https://fernandosanchezinstituto.com.mx/examen-principios-de-pnl/"
    }
]
...
output_file = os.path.join(output_dir, "snippet-examenes-pnl.html")
