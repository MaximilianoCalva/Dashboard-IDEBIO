...
exams = [
    {
        "title": "EXAMEN: BIOPSICOLOGÍA",
        "url": "https://fernandosanchezinstituto.com.mx/examen-biopsicologia/"
    }
]
...
output_file = os.path.join(output_dir, "snippet-examenes-biopsicologia.html")
